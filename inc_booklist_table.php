<div id="booklist">
	...
	<table id="booklistTBL" class="tablesorter">
		<thead data-order="1">
			<tr>
				<th tabindex="0" id="booklist-titles">Tittel</th>
				<th tabindex="0" id="booklist-authors">Forfatter(e)</th>
				<th tabindex="0" class="price" data-type="number" id="booklist-prices">Pris</th>
			</tr>
		</thead>
		<tbody>
			<tr>
			...
			<tr>
				<td><a href="#9788299793292">Formidling for framtida: tanker om arkiv</a>
				</td>
				<td>Hilde Lange og Ulrike Spring (Red.)</td>
			...
			<tr>
				<td><a href="#9788293298168">Gender Equality in the Norwegian Armed Forces</a></td>
				<td>Dag Ellingsen, Ulla-Britt Lilleaas – with a foreword by Michael Kimmel</td>
