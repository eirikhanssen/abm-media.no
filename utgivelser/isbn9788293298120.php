<div id="utgivelse">
    <div class="booktitle-wrap">
        <img alt="Coverbilde for Samle, formidle, dele. 75 år med bibliotekarutdanning" src="img/samle-formidle-dele-422x600.jpg" style="
                            float:right;
                        " class="titlecover" height="150" width="105">
        <h2 class="booktitle">Samle, formidle, dele. 75 år med bibliotekarutdanning</h2>
        <h3 class="authors">Ragnar Audunson (red.)</h3>
    </div>
    <ul class="bookmeta">
    ...
    <p><em>Hva skal vi med fagutdannede bibliotekarer når folkebibliotekene helst vil være kultur- og litteraturhus?</em></p>
    <p>Bibliotekene og bibliotekarprofesjonen er under debatt. Utvidelsen av formålsparagrafen i Lov om folkebibliotek har fått bibliotekledere til å spørre om man trenger andre typer kompetanse enn den bibliotek- og informasjonsfaglig utdanning tilbyr. Andre argumenterer for at bibliotekets og bibliotekarenes betydning blir mindre når man har tilgang til hele internettet fra nærmeste telefon og nettbrett.</p>
    <p>Bibliotekets oppgave var opprinnelig å ha gode samlinger. I dag er oppgaven å sikre tilgang til de beste kildene. Derfor trenger vi fortsatt hjelp av fagpersoner til skille skitt fra kanel i en stadig mer kompleks verden av kulturuttrykk, kunnskap og informasjon.</p>
