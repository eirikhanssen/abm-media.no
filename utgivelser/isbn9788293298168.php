<div id="utgivelse">
    <div class="booktitle-wrap">
        <img alt="Coverbilde for Gender Equality in the Norwegian Armed Forces" src="img/9788293298168.jpg" style="
                            float:right;
                        " class="titlecover" height="150" width="110">
        <h2 class="booktitle">Gender Equality in the Norwegian Armed Forces</h2>
        <h3 class="authors">Dag Ellingsen, Ulla-Britt Lilleaas – with a foreword by Michael Kimmel</h3>
    </div>
    <ul class="bookmeta">
    ...
    <p>Distinguished Professor Michael Kimmel, State University of New York (SUNY) in his foreword.</p>
    <h3>Om forfatterne</h3>
    <h4>Dag Ellingsen</h4>
    <p>Dag er Forsker II ved Senter for velferds- og arbeidslivsforskning, AFI.</p>
    <h4>Ulla-Britt Lilleaas</h4>
    <p>Ulla-Britt er professor ved Universitetet i Agder og leder for Senter for likestilling i Agder.</p>
    <h3>Omslag</h3>
    <img alt="Gender Equality in the Norwegian Armed Forces." src="img/9788293298168.jpg" class="fullsizecover" height="600" width="436">
</div>